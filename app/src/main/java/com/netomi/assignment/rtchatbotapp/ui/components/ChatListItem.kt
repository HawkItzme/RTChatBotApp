package com.netomi.assignment.rtchatbotapp.ui.components
...
import com.netomi.assignment.rtchatbotapp.data.model.ChatThread
...
private fun formatShortTime(lastAt: Long): String {
    ...
    return when {
        ...
        diff < 86_400_000 -> "${diff / 3600_000}h ago"
            ...
            date.format(java.util.Date(lastAt))
        }
    }
}
